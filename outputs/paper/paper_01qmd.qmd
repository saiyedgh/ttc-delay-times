...
data_url <- "https://open.toronto.ca/dataset/bike-share-toronto-ridership-data/"

# lists all the reosources available using the link
packages_data <- data_url %>%
  list_package_resources()
packages_data

data_2015 <- filter(packages_data, id == "85326868-508c-497e-b139-b698aaf27bbf")

data_2015 <- data_2015 |> 
  get_resource()

data_2015 <- data_2015[["Demographics"]]
